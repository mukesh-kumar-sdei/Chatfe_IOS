...
//    func didDeSelectCellAtIndexPath(_ collectionView: UICollectionView, usableIndexPath: IndexPath)
//    func shouldSelectItemAtIndexPath(_ collectionView: UICollectionView, usableIndexPath: IndexPath) -> Bool
//    func willDisplayItemAtIndexPath(_ collectionView: UICollectionView, usableIndexPath: IndexPath)
}
...
extension InfiniteCollectionView: UICollectionViewDelegate
{
    ...
    {
        infiniteDelegate?.didDeSelectCellAtIndexPath(self, usableIndexPath: IndexPath(row: getCorrectedIndex(indexPath.row - indexOffset), section: 0))
    }
    
    func collectionView(_ collectionView: UICollectionView, shouldSelectItemAt indexPath: IndexPath) -> Bool {
        infiniteDelegate?.shouldSelectItemAtIndexPath(self, usableIndexPath: IndexPath(row: getCorrectedIndex(indexPath.row - indexOffset), section: 0)) ?? false
    }
    
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        infiniteDelegate?.willDisplayItemAtIndexPath(self, usableIndexPath: IndexPath(row: getCorrectedIndex(indexPath.row - indexOffset), section: 0))
    }*/
}
